...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DPGL-beq.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-6M9Lh1j7.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-ldMSZf_w.mjs').then((r) => r.default || r));
